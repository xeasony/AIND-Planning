            ...
            for cargo in self.cargos:
                for plane in self.planes:
                    for airport in self.airports:
                        ...
                        action_expr = expr("Load({}, {}, {})".format(cargo, plane, airport))
                        precond = [precond_pos, precond_neg]
                        effect = [effect_add, effect_rem]

                        load_action = Action(action_expr, precond, effect)
            ...
            for cargo in self.cargos:
                for plane in self.planes:
                    for airport in self.airports:
                        ...
                        action_expr = expr("Unload({}, {}, {})".format(cargo, plane, airport))
                        precond = [precond_pos, precond_neg]
                        effect = [effect_add, effect_rem]

                        unload_action = Action(action_expr, precond, effect)
